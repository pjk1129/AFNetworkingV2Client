...
- (void)start
{
    ...
    else
    {
        ...
        {      
            self.completedBlock(nil, nil, [NSError errorWithDomain:NSURLErrorDomain code:0 userInfo:[NSDictionary dictionaryWithObject:@"Connection can't be initialized" forKey:NSLocalizedDescriptionKey]], YES);
        }
    }
}
    ...
    if (completionBlock)
    {
        ...
        else
        {
            ...
            if (CGSizeEqualToSize(image.size, CGSizeZero))
            {
                ...
                completionBlock(nil, nil, [NSError errorWithDomain:@"SDWebImageErrorDomain" code:0 userInfo:[NSDictionary dictionaryWithObject:@"Downloaded image has 0 pixels" forKey:NSLocalizedDescriptionKey]], YES);
            }
            else
            {
